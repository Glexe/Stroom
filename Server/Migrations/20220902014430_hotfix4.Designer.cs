...
namespace Stroom.Server.Migrations
{
    ...
    [Migration("20220902014430_hotfix4")]
            ...
            modelBuilder.Entity("Stroom.Shared.Models.CommentDto", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            TimeStamp = new DateTime(2022, 9, 3, 3, 44, 29, 847, DateTimeKind.Local).AddTicks(4130)
                        });
                });
            ...
            modelBuilder.Entity("Stroom.Shared.Models.TaskDto", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            DueDate = new DateTime(2022, 9, 9, 3, 44, 29, 847, DateTimeKind.Local).AddTicks(4122),
                            EstimatedTime = 13f,
                            Name = "Change start button color",
                            Priority = 0,
                            ProjectID = 1,
                            Status = 0,
                            SubmitionDate = new DateTime(2022, 9, 2, 3, 44, 29, 847, DateTimeKind.Local).AddTicks(4085)
                        });
                });
            ...
            modelBuilder.Entity("Stroom.Shared.Models.TimeEntry", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            TimeEntryID = 1,
                            Date = new DateTime(2022, 8, 31, 3, 44, 29, 847, DateTimeKind.Local).AddTicks(4125),
                            Hours = 3f,
                            TaskID = 1,
                            UserID = 1
                        });
